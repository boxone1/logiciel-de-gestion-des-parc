        ...
        void SetupPrint()
        {
            ...
            */
            ...
            if (!EmbeddedPrinting)
            {
                ...
                PrintMargins.Right = 10;// (hardx > PrintMargins.Right) ? hardx : PrintMargins.Right;
                PrintMargins.Left = 10;//(hardx > PrintMargins.Left) ? hardx : PrintMargins.Left;
                PrintMargins.Top = 10;// (hardy > PrintMargins.Top) ? hardy : PrintMargins.Top;
                PrintMargins.Bottom = 40;// (hardy > PrintMargins.Bottom) ? hardy : PrintMargins.Bottom;
